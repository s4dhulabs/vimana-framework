...
from siddhis.framewire.utils import should_show_banner, fw_banner
from siddhis.framewire.engines.spec_manager import SpecResolutionError
from siddhis.framewire.orchestrator import run_spec_scan, run_frame_audit
...
class siddhi:
    ...
    def start(self):
        ...
        scan_only = handler.get('api_scan_enabled') and not handler.get('frame_audit_enabled')

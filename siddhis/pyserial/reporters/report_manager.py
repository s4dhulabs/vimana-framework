...
class ReportManager:
    def __init__(self, results, export_format='json', verbose=False):
    ...
    def _generate_json_report(self):
        ...
        try:
            output_file = f"pyserial_tests_{self.timestamp}.json"
    ...
    def _generate_csv_report(self):
        """Generate CSV report"""
        try:
            output_file = f"pyserial_tests_{self.timestamp}.csv"
            with open(output_file, 'w') as f:
    ...
    def _generate_pdf_report(self):
        ...
        try:
            ...
            output_file = f"pyserial_tests_{self.timestamp}.pdf"

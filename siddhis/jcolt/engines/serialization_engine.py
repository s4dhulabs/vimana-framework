...
logger = logging.getLogger("jcolt.serialization_engine")
...
def import_interactive_builder():
    ...
    try:
        from siddhis.jcolt.engines.payloads import launch_interactive_builder
...
def run_serialization_tests(vmnf_handler: Dict[str, Any], schema: Dict[str, Any]) -> Dict[str, Any]:
    """
    Entry point function for running serialization tests from JColt.
                        ...
                        try:
                            ...
                            if response:
                                ...
                                try:
                                    ...
                                    # Always save detailed test information to log files
